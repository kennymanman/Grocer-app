...
import { View, Text, StyleSheet, Image, ScrollView, SafeAreaView, TouchableOpacity, FlatList, ImageBackground } from "react-native"
...
<ScrollView showsHorizontalScrollIndicator={false} >
        ...
        onPress={() => navigation.openDrawer()} />
            ...
            <Image  style={{ width: 349, height: 100, alignItems: "center", borderRadius: 19, marginTop: 18}} source={ban} />

            <Image  style={{ width: 349, height: 350, alignItems: "center", borderRadius: 20, marginTop: 15}} source={hus} />

            <Image  style={{ width: 349, height: 290, alignItems: "center", borderRadius: 20, marginTop: 15}} source={fresh} />
...
<Title style={{textAlign:"left", fontSize:35, marginLeft:8}}>Deals</Title>
<Text style={{marginLeft:12, fontSize:13, marginTop:8}}>Enjoy deals, offers and discounts at affordable prices.</Text> 

<TouchableOpacity onPress={() => navigation.navigate ( "DealsScreen") }> 
<Text style={{marginLeft:12, fontSize:13, color:"blue", marginTop:5}}>See all deals</Text> 
</TouchableOpacity>
